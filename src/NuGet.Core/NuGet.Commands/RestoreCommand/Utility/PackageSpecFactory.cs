...
namespace NuGet.Commands.Restore.Utility
{
    public static class PackageSpecFactory
    {
        ...
        private static (ProjectRestoreMetadata? RestoreMetadata, List<TargetFrameworkInformation>? TargetFrameworkInfos) GetProjectRestoreMetadataAndTargetFrameworkInformation(IProject project, ISettings settings)
        {
            ...
            RestoreAuditProperties? auditProperties = GetRestoreAuditProperties(outerBuild, GetAuditSuppressions(outerBuild));
        ...
        private static RestoreAuditProperties? GetRestoreAuditProperties(ITargetFramework project, HashSet<string>? suppressionItems)
        {
            string enableAudit = project.GetProperty("NuGetAudit");
            string auditLevel = project.GetProperty("NuGetAuditLevel");
            string auditMode = project.GetProperty("NuGetAuditMode");
